...
class Pagination
{
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a class="page prev" href="' . htmlspecialchars($this->getPrevUrl()) . '" data-page="'.$this->getPrevPage().'">'. $this->previousText .'</a></li>';
        }

        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li><a '.($page['isCurrent'] ? ' class="page active"' : 'class="page"').' href="' . htmlspecialchars($page['url']) . '" data-page="'.$page['num'].'">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a class="page next" href="' . htmlspecialchars($this->getNextUrl()) . '" data-page="'.$this->getNextPage().'">'. $this->nextText .'</a></li>';
        }
        $html .= '</ul>';
