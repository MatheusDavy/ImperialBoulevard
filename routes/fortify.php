...
use App\Http\Controllers\Adm\Auth\ForgotCodeController;
...
Route::prefix('adm')->middleware(config('fortify.middleware', ['web']))->group(
    function () {
        ...
        if ($enableViews) {
            ...
            Route::post('/forgotCode', [ForgotCodeController::class, 'send'])
            ->middleware(
                array_filter(
                    [
